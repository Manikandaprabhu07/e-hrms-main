...
let NotificationsController = class NotificationsController {
    ...
    stream(req) {
        return (0, rxjs_1.fromEvent)(this.notificationsService.events, 'notification').pipe((0, operators_1.filter)((payload) => payload?.userId === req.user.id), (0, operators_1.map)((payload) => ({ data: payload })));
    }
    async readAll(req) {

...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('training.read'),
...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'SUB_ADMIN', 'ADMIN', 'HR'),
    (0, permissions_decorator_1.Permissions)('training.write'),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('SUPER_ADMIN', 'SUB_ADMIN', 'ADMIN', 'HR'),
    (0, permissions_decorator_1.Permissions)('training.delete'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
